...
const CONQUISTAS = [
  ...
  { id: 5, nome: 'Jardineiro', desc: '5 plantas ativas', img: 'https://images.unsplash.com/photo-1459411552884-841db9b3cc2a?w=80&q=80' },
  { id: 6, nome: 'Floresta', desc: '10 plantas', img: 'https://images.unsplash.com/photo-1614594975525-e45190c55d0b?w=80&q=80' },
  { id: 7, nome: 'Expert', desc: '100 entradas', img: 'https://images.unsplash.com/photo-1585058178215-33108215e3c8?w=80&q=80' },
  { id: 8, nome: 'Mestre', desc: '50 adoções', img: 'https://images.unsplash.com/photo-1597305877032-0668b3c7f3a6?w=80&q=80' },
]
...
export default function Perfil() {
  ...
  const earnedIds = [1, 2, 3, 4, 5]

  const handleSave = () => toast('Perfil atualizado!')
        ...
        <div>
          <div className="perfil-sec">
            ...
            <div className="form-grid-2">
              ...
              <div className="field"><label>Nova senha</label><input type="password" placeholder="Nova senha" /></div>
            </div>
